...
export const FONT_STYLES = {
  ...
  PRETENDARD_M_24: FONT({ font: 'Pretendard', size: 24, weight: 'M', height: 22 }),
  ...
  PRETENDARD_B_18: FONT({ font: 'Pretendard-BOLD', size: 18, weight: 'B', height: 25 }),
  ...
  PRETENDARD_B_34: FONT({ font: 'Pretendard-BOLD', size: 34, weight: 'B', height: 33.6 }),
  ...
  NEXON_R_18: FONT({ font: 'NEXON Lv1 Gothic OTF', size: 18, weight: 'R', height: 23.4 }),
  ...
  NEXON_B_28: FONT({ font: 'NEXON Lv1 Gothic Bold', size: 28, weight: 'B', height: 22 }),
