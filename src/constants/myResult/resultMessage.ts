...
export const RESULT_MESSAGE = [
  {
    ...
    recommendText: [
      ...
      '뛰어난 팀은 서로 감추지 않아요. 비난을 두려워하지 않고\n약점을 인정해요.',
    ],
  },
  {
    input: 'B',
    ...
    resultDetail: [
      '동기부여가 부족한 당신!',
      '재충전이 필요한 마카롱이네요!',
      '달달한 마카롱 한입으로 재충전해 보시는 것은 어떨까요?',
    ],
    recommendText: [
      '비전을 갖고 목표를 세워요.',
      '미래에 집중하세요.',
      '내가 이미 미래에 성공을 이룬 것처럼 행동해 보세요.',
      '재충전의 시간을 보내보세요. ',
    ],
  },
  {
    ...
    resultDetail: [
      '더 큰 성장을 꿈꾸는 당신! ',
      '번쩍 성장을 꿈꾸는 에클레어네요!',
      '번개의 의미를 가진 에클레어처럼 더 큰 성장을 해보아요!',
    ],
    recommendText: [
      '팀의 사람들과 함께 커리어 방향에 대해 많은 대화를 \n 나누어 보세요.',
      '적극적으로 자신이 원하는 업무를 할 기회를 만들어보세요.',
      '업무에서의 목표를 최대한 구체적으로 작성해 보아요.',
  ...
  },
  {
    ...
    resultDetail: [
      ...
      '겉바속촉을 꿈꾸는 까눌레군요!',
      '까눌레처럼 일과 개인생활 모두 잡아보시는 건 어떨까요?',
    ],
    recommendText: [
      '때때로 손에서 일을 놓고 휴식을 취해야 해요.',
      '휴식이 곧 회복이에요. 짧은 휴식이라도 푹 쉬어주세요.',
      '더 많은 성과를 내고 싶다면, 내 시간의 진정한 \n주인이 되세요.',
      '효율이란 일을 제대로 하는 것이고, 효과란 올바른 일을 \n하는 것이에요.',
    ],
  },
  {
    input: 'E',
    ...
    resultDetail: [
      ...
      '눈물 젖은 소금빵이네요!',
      '소금빵 한입으로 뚝 그쳐보시는 거 어떨까요?',
    ],
    recommendText: [
      '점심시간 등을 활용해 30분 정도 햇빛을 봐주세요.',
      '지나친 음주와 카페인은 삼가주세요!',
      '10분 정도의 스트레칭도 몸과 마음에 많은 도움이 되어요.',
      '충분한 수면을 취해주세요.',
    ],
  },
];
